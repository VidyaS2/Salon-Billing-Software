...
<head>
  ...
  <title>Salon - Customer Form</title>
  <!-- loader-->
      ...
      <div class="row mt-3">
        <div class="col-lg-12">
          <div class="card" id="customer-form-container">
            <div class="card-body">
              <div class="card-title">Customer Details Form</div>
              <hr>
              
              <h3>Existing Customer</h3>
              <div class="form-group mt-3" id="customer-id-container">
                  <label for="customer-id">Enter Mobile No</label>
                  <input type="number" class="form-control" id="customer-id" placeholder="Enter Mobile No">
              </div>
              <button class="btn btn-success" id="check-customer">Check</button>
              ...
              <form action="customer-backend.php" method="post" id="customer-form" class="hidden mt-3">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-rounded" id="input-7" name="email" placeholder="Enter Email Address">
                  </div>
                  <div class="form-group">
                      <label for="input-8">Mobile</label>
                      <input type="text" class="form-control form-control-rounded" id="input-8" name="mobile" placeholder="Enter Mobile Number" required>
                  </div>
                  <div class="form-group">
                      <label for="input-9">Stylist Name</label>
                      <input type="text" class="form-control form-control-rounded" id="input-9" name="stylist" placeholder="Enter Stylist Name" required>
                  </div>
                  <div class="form-group">
                      ...
                      <div id="services-container">
                          <div class="row mb-2">
                              ...
                              <select class="form-control form-control-rounded" name="services[]" required> 
                                    <option value="threading">Select Service</option>
