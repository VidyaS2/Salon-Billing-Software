  ...
  <div class="content-wrapper">
    ...
    <div class="row">
        ...
        <tbody>
            ...
            $sql = "SELECT cd.timestamp, cd.name, cd.mobile, GROUP_CONCAT(s.service_name SEPARATOR ', ') AS services
                    FROM customer_details cd
                    JOIN services s ON cd.id = s.customer_id
                    JOIN register r ON cd.stylist = r.username
                    WHERE r.username = ?
                    GROUP BY cd.id";
