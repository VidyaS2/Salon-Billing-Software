...
<head>
  ...
  <title>Salon - Employee Form</title>
  <!-- loader-->
    ...
    <div class="row mt-3">
      ...
      <div class="col-lg-12" >
        <div class="card" id="employee-form-container">
           <div class="card-body">
           <div class="card-title">Employee Details Form</div>
           <hr>
            <form action="employee-backend.php" method="post">
           <div class="form-group">
            <label for="input-6">Name</label>
            <input type="text" class="form-control form-control-rounded" name="name" id="input-6" placeholder="Enter Name">
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control form-control-rounded" name="address" id="input-9" placeholder="Enter Address">
           </div>
           <div class="form-group">
            <label for="input-10">Role</label>
            <input type="text" class="form-control form-control-rounded" name="role" id="input-10" placeholder="Enter Role">
           </div>
           ...
           <div class="form-group">
            <button type="submit" name="employee" class="btn btn-light btn-round px-5"><i class="icon-lock"></i> Register</button>
          </div>
          </form>
         </div>
         </div>
